                                ...
                                myRef.child("patient").child(key).child("avatar").addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot childsnapshot) {
                                        ...
                                        dialogBuilder
                                                ...
                                                .withButton1Text("Dongy")                                      //def gone
                                                .withButton2Text("Cancel") //def gone
                                                .setButton1Click(new View.OnClickListener() {
                                                    @Override
                                                    public void onClick(View v) {
                                                        Toast.makeText(Main_Screen_Acitivity.this, dataSnapshot.getValue(String.class).split("_")[1].trim(), Toast.LENGTH_SHORT).show();
                                                        Toast.makeText(Main_Screen_Acitivity.this, dataSnapshot.getValue(String.class).split("_")[0].trim(), Toast.LENGTH_SHORT).show();
                                                        Toast.makeText(Main_Screen_Acitivity.this, Main_Screen_Acitivity.getDoctor().getPhone(), Toast.LENGTH_SHORT).show();

                                                        myRef.child("request_zone").child(dataSnapshot.getValue(String.class).split("_")[1].trim()).child(dataSnapshot.getValue(String.class).split("_")[0].trim()).child("Doctor").setValue(Main_Screen_Acitivity.getDoctor().getPhone());
                                                        ...
                                                        myRef.child("doctor").child(Main_Screen_Acitivity.getKey()).child("type").setValue("waiting");
